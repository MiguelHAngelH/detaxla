...
class _BounceState extends State<Bounce> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationUp = Tween<double>(begin: 0, end: widget.from * -1)
        .animate(CurvedAnimation(curve: const Interval(0, 0.35, curve: Curves.easeInOut), parent: controller!));

    animationBounce = Tween<double>(begin: widget.from * -1, end: 0.0)
        .animate(CurvedAnimation(curve: const Interval(0.35, 1, curve: Curves.bounceOut), parent: controller!));
...
class Pulse extends StatefulWidget {
  ...
  final bool manualTrigger;
  final bool animate;
  final double beginInc;
  final double endInc;
  final double beginDesc;
  final double endDesc;
  Pulse(
      {key,
      required this.child,
      this.duration = const Duration(milliseconds: 1000),
...
class _PulseState extends State<Pulse> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationInc = Tween<double>(begin: widget.beginInc, end: widget.endInc)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0, 0.5, curve: Curves.easeOut)));

    animationDec = Tween<double>(begin: widget.beginDesc, end: widget.endDesc)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.5, 1, curve: Curves.easeIn)));
...
class _SwingState extends State<Swing> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationRotation2 = Tween<double>(begin: -0.5, end: 0.5)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.1666, 0.3333, curve: Curves.easeInOut)));

    animationRotation3 = Tween<double>(begin: 0.5, end: -0.5)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.3333, 0.4999, curve: Curves.easeInOut)));

    animationRotation4 = Tween<double>(begin: -0.5, end: 0.4)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.4999, 0.6666, curve: Curves.easeInOut)));

    animationRotation5 = Tween<double>(begin: 0.4, end: -0.4)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.6666, 0.8333, curve: Curves.easeInOut)));
...
/// State class, where the magic happens
class _SpinPerfectState extends State<SpinPerfect> with SingleTickerProviderStateMixin {
  AnimationController? controller;
  bool disposed = false;
  late Animation<double> spin;
...
class _DanceState extends State<Dance> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    step1 =
        Tween<double>(begin: 0, end: -0.2).animate(CurvedAnimation(parent: controller!, curve: const Interval(0, 0.3333, curve: Curves.bounceOut)));

    step2 = Tween<double>(begin: -0.2, end: 0.2)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.3333, 0.6666, curve: Curves.bounceOut)));

    step3 =
        Tween<double>(begin: 0.2, end: 0).animate(CurvedAnimation(parent: controller!, curve: const Interval(0.6666, 1, curve: Curves.bounceOut)));
